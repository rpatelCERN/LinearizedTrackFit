...
//      hCorrelationNeg_.push_back(new TH2F(name+"_negative", name+"_negative", 1000, minVar[var], maxVar[var], 1000, minPar[par], maxPar[par]));
      hCorrelationPos_.push_back(new TH2F(name+"_positive", name+"_positive", 1000, minVar[var], maxVar[var], 1000, 0., 0.));
      hCorrelationNeg_.push_back(new TH2F(name+"_negative", name+"_negative", 1000, minVar[var], maxVar[var], 1000, 0., 0.));
    }
  }
}
