...
//  if (stubs[0].modid() != 5003223) return false;
//  if (stubs[1].modid() != 6002815) return false;
//  if (stubs[2].modid() != 7002814) return false;
//  if (stubs[3].modid() != 8001200) return false;
//  if (stubs[4].modid() != 9001200) return false;
//  if (stubs[5].modid() != 10001301) return false;

  if (stubs[0].module() != 29 || stubs[0].ladder() != 0) return false;
  if (stubs[1].module() != 25 || stubs[1].ladder() != 0) return false;
  if (stubs[2].module() != 25 || stubs[2].ladder() != 0) return false;
  if (stubs[3].module() != 11 || stubs[3].ladder() != 0) return false;
  if (stubs[4].module() != 11 || stubs[4].ladder() != 0) return false;
  if (stubs[5].module() != 11 || stubs[5].ladder() != 0) return false;
  return true;
}
