...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 98
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 99
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 100
process.RandomNumberGeneratorService.mix.initialSeed            = 101
...
process.MIBextraction.extractedRootFile = "extracted_98.root"
