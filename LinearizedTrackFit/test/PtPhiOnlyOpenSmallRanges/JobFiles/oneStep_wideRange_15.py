...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 15
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 16
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 17
process.RandomNumberGeneratorService.mix.initialSeed            = 18
...
process.MIBextraction.extractedRootFile = "extracted_15.root"
