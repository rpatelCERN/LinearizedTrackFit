...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 19
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 20
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 21
process.RandomNumberGeneratorService.mix.initialSeed            = 22
...
process.MIBextraction.extractedRootFile = "extracted_19.root"
