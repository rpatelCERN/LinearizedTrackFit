...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 71
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 72
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 73
process.RandomNumberGeneratorService.mix.initialSeed            = 74
...
process.MIBextraction.extractedRootFile = "extracted_71.root"
