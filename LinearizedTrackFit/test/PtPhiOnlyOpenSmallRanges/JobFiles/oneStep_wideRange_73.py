...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 73
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 74
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 75
process.RandomNumberGeneratorService.mix.initialSeed            = 76
...
process.MIBextraction.extractedRootFile = "extracted_73.root"
