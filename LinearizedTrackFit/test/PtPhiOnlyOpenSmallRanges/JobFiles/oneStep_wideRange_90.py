...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 90
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 91
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 92
process.RandomNumberGeneratorService.mix.initialSeed            = 93
...
process.MIBextraction.extractedRootFile = "extracted_90.root"
