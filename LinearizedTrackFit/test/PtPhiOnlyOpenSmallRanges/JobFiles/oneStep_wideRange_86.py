...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 86
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 87
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 88
process.RandomNumberGeneratorService.mix.initialSeed            = 89
...
process.MIBextraction.extractedRootFile = "extracted_86.root"
