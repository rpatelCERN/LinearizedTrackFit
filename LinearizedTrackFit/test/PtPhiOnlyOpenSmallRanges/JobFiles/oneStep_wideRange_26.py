...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 26
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 27
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 28
process.RandomNumberGeneratorService.mix.initialSeed            = 29
...
process.MIBextraction.extractedRootFile = "extracted_26.root"
