...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 49
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 50
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 51
process.RandomNumberGeneratorService.mix.initialSeed            = 52
...
process.MIBextraction.extractedRootFile = "extracted_49.root"
