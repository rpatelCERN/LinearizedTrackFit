...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 52
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 53
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 54
process.RandomNumberGeneratorService.mix.initialSeed            = 55
...
process.MIBextraction.extractedRootFile = "extracted_52.root"
