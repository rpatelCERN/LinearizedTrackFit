...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 18
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 19
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 20
process.RandomNumberGeneratorService.mix.initialSeed            = 21
...
process.MIBextraction.extractedRootFile = "extracted_18.root"
