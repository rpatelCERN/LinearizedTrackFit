...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 88
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 89
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 90
process.RandomNumberGeneratorService.mix.initialSeed            = 91
...
process.MIBextraction.extractedRootFile = "extracted_88.root"
