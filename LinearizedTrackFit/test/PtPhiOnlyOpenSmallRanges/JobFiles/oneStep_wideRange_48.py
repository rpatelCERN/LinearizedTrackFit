...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 48
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 49
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 50
process.RandomNumberGeneratorService.mix.initialSeed            = 51
...
process.MIBextraction.extractedRootFile = "extracted_48.root"
