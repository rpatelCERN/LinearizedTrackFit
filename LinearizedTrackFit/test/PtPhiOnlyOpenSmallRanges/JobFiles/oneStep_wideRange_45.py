...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 45
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 46
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 47
process.RandomNumberGeneratorService.mix.initialSeed            = 48
...
process.MIBextraction.extractedRootFile = "extracted_45.root"
