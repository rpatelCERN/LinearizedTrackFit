...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 16
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 17
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 18
process.RandomNumberGeneratorService.mix.initialSeed            = 19
...
process.MIBextraction.extractedRootFile = "extracted_16.root"
