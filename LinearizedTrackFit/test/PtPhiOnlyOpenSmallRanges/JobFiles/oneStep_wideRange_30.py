...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 30
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 31
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 32
process.RandomNumberGeneratorService.mix.initialSeed            = 33
...
process.MIBextraction.extractedRootFile = "extracted_30.root"
