...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 94
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 95
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 96
process.RandomNumberGeneratorService.mix.initialSeed            = 97
...
process.MIBextraction.extractedRootFile = "extracted_94.root"
