...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 47
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 48
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 49
process.RandomNumberGeneratorService.mix.initialSeed            = 50
...
process.MIBextraction.extractedRootFile = "extracted_47.root"
