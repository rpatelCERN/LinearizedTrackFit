...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 79
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 80
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 81
process.RandomNumberGeneratorService.mix.initialSeed            = 82
...
process.MIBextraction.extractedRootFile = "extracted_79.root"
