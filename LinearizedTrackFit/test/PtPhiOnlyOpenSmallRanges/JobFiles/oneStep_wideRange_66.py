...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 66
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 67
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 68
process.RandomNumberGeneratorService.mix.initialSeed            = 69
...
process.MIBextraction.extractedRootFile = "extracted_66.root"
