...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 28
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 29
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 30
process.RandomNumberGeneratorService.mix.initialSeed            = 31
...
process.MIBextraction.extractedRootFile = "extracted_28.root"
