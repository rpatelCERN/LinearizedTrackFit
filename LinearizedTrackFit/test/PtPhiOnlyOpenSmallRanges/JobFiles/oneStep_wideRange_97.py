...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 97
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 98
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 99
process.RandomNumberGeneratorService.mix.initialSeed            = 100
...
process.MIBextraction.extractedRootFile = "extracted_97.root"
