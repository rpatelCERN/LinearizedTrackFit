...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 50
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 51
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 52
process.RandomNumberGeneratorService.mix.initialSeed            = 53
...
process.MIBextraction.extractedRootFile = "extracted_50.root"
