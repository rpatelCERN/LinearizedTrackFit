...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 31
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 32
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 33
process.RandomNumberGeneratorService.mix.initialSeed            = 34
...
process.MIBextraction.extractedRootFile = "extracted_31.root"
