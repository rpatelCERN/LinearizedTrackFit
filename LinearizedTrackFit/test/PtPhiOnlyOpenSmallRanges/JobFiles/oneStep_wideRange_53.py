...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 53
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 54
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 55
process.RandomNumberGeneratorService.mix.initialSeed            = 56
...
process.MIBextraction.extractedRootFile = "extracted_53.root"
