...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 99
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 100
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 101
process.RandomNumberGeneratorService.mix.initialSeed            = 102
...
process.MIBextraction.extractedRootFile = "extracted_99.root"
