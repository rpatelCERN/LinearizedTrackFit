...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 93
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 94
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 95
process.RandomNumberGeneratorService.mix.initialSeed            = 96
...
process.MIBextraction.extractedRootFile = "extracted_93.root"
