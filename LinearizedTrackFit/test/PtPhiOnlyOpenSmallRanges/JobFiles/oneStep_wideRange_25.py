...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 25
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 26
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 27
process.RandomNumberGeneratorService.mix.initialSeed            = 28
...
process.MIBextraction.extractedRootFile = "extracted_25.root"
