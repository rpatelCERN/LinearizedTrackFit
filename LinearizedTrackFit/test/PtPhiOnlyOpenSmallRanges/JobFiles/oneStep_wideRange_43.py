...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 43
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 44
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 45
process.RandomNumberGeneratorService.mix.initialSeed            = 46
...
process.MIBextraction.extractedRootFile = "extracted_43.root"
