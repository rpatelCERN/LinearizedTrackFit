...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 82
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 83
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 84
process.RandomNumberGeneratorService.mix.initialSeed            = 85
...
process.MIBextraction.extractedRootFile = "extracted_82.root"
