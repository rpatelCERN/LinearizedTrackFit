...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 21
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 22
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 23
process.RandomNumberGeneratorService.mix.initialSeed            = 24
...
process.MIBextraction.extractedRootFile = "extracted_21.root"
