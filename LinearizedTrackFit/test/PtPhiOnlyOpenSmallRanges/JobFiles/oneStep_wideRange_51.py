...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 51
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 52
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 53
process.RandomNumberGeneratorService.mix.initialSeed            = 54
...
process.MIBextraction.extractedRootFile = "extracted_51.root"
