...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 85
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 86
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 87
process.RandomNumberGeneratorService.mix.initialSeed            = 88
...
process.MIBextraction.extractedRootFile = "extracted_85.root"
