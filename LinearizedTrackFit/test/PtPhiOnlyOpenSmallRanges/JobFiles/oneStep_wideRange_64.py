...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 64
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 65
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 66
process.RandomNumberGeneratorService.mix.initialSeed            = 67
...
process.MIBextraction.extractedRootFile = "extracted_64.root"
