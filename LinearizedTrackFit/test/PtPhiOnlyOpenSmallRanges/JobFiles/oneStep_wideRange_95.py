...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 95
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 96
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 97
process.RandomNumberGeneratorService.mix.initialSeed            = 98
...
process.MIBextraction.extractedRootFile = "extracted_95.root"
