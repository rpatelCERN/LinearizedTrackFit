...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 75
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 76
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 77
process.RandomNumberGeneratorService.mix.initialSeed            = 78
...
process.MIBextraction.extractedRootFile = "extracted_75.root"
