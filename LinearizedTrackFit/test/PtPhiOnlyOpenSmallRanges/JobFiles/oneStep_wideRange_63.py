...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 63
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 64
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 65
process.RandomNumberGeneratorService.mix.initialSeed            = 66
...
process.MIBextraction.extractedRootFile = "extracted_63.root"
