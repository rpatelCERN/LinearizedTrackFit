...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 42
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 43
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 44
process.RandomNumberGeneratorService.mix.initialSeed            = 45
...
process.MIBextraction.extractedRootFile = "extracted_42.root"
