...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 87
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 88
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 89
process.RandomNumberGeneratorService.mix.initialSeed            = 90
...
process.MIBextraction.extractedRootFile = "extracted_87.root"
