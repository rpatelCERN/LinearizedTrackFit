...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 24
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 25
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 26
process.RandomNumberGeneratorService.mix.initialSeed            = 27
...
process.MIBextraction.extractedRootFile = "extracted_24.root"
