...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 69
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 70
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 71
process.RandomNumberGeneratorService.mix.initialSeed            = 72
...
process.MIBextraction.extractedRootFile = "extracted_69.root"
