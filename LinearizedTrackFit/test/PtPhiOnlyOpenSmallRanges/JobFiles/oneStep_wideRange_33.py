...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 33
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 34
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 35
process.RandomNumberGeneratorService.mix.initialSeed            = 36
...
process.MIBextraction.extractedRootFile = "extracted_33.root"
