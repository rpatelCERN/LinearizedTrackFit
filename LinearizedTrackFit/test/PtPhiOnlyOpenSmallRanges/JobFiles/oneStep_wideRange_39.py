...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 39
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 40
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 41
process.RandomNumberGeneratorService.mix.initialSeed            = 42
...
process.MIBextraction.extractedRootFile = "extracted_39.root"
