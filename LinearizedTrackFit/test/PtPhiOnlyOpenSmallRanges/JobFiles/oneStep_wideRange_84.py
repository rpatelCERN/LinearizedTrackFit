...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 84
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 85
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 86
process.RandomNumberGeneratorService.mix.initialSeed            = 87
...
process.MIBextraction.extractedRootFile = "extracted_84.root"
