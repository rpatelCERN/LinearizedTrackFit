...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 35
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 36
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 37
process.RandomNumberGeneratorService.mix.initialSeed            = 38
...
process.MIBextraction.extractedRootFile = "extracted_35.root"
