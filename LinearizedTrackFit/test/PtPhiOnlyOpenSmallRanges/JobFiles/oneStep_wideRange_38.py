...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 38
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 39
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 40
process.RandomNumberGeneratorService.mix.initialSeed            = 41
...
process.MIBextraction.extractedRootFile = "extracted_38.root"
