...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 54
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 55
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 56
process.RandomNumberGeneratorService.mix.initialSeed            = 57
...
process.MIBextraction.extractedRootFile = "extracted_54.root"
