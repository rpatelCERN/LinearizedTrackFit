...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 17
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 18
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 19
process.RandomNumberGeneratorService.mix.initialSeed            = 20
...
process.MIBextraction.extractedRootFile = "extracted_17.root"
