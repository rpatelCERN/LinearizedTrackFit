...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 44
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 45
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 46
process.RandomNumberGeneratorService.mix.initialSeed            = 47
...
process.MIBextraction.extractedRootFile = "extracted_44.root"
