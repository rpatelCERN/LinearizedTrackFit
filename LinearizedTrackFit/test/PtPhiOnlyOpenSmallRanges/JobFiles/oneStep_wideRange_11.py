...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 11
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 12
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 13
process.RandomNumberGeneratorService.mix.initialSeed            = 14
...
process.MIBextraction.extractedRootFile = "extracted_11.root"
