...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 91
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 92
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 93
process.RandomNumberGeneratorService.mix.initialSeed            = 94
...
process.MIBextraction.extractedRootFile = "extracted_91.root"
