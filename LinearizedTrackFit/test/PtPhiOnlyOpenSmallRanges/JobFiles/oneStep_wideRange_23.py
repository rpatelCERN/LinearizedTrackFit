...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 23
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 24
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 25
process.RandomNumberGeneratorService.mix.initialSeed            = 26
...
process.MIBextraction.extractedRootFile = "extracted_23.root"
