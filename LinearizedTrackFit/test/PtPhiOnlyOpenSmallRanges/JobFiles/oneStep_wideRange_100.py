...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 100
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 101
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 102
process.RandomNumberGeneratorService.mix.initialSeed            = 103
...
process.generator = cms.EDProducer("FlatRandomOneOverPtGunProducer",
	...
	# 95 < pt < 105 GeV
	MinOneOverPt = cms.double(1./105.),
        MaxOneOverPt = cms.double(1./95.),
...
process.MIBextraction.extractedRootFile = "extracted_100.root"
