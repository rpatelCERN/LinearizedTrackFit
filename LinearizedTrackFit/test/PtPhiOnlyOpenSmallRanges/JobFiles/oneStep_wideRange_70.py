...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 70
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 71
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 72
process.RandomNumberGeneratorService.mix.initialSeed            = 73
...
process.MIBextraction.extractedRootFile = "extracted_70.root"
