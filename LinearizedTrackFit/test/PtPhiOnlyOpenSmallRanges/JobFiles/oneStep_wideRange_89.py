...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 89
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 90
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 91
process.RandomNumberGeneratorService.mix.initialSeed            = 92
...
process.MIBextraction.extractedRootFile = "extracted_89.root"
