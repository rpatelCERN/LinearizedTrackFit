...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 13
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 14
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 15
process.RandomNumberGeneratorService.mix.initialSeed            = 16
...
process.MIBextraction.extractedRootFile = "extracted_13.root"
