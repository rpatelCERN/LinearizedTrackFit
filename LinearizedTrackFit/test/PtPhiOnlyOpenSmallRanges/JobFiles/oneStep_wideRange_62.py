...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 62
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 63
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 64
process.RandomNumberGeneratorService.mix.initialSeed            = 65
...
process.MIBextraction.extractedRootFile = "extracted_62.root"
