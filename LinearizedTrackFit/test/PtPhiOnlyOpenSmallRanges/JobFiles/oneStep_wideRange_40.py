...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 40
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 41
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 42
process.RandomNumberGeneratorService.mix.initialSeed            = 43
...
process.MIBextraction.extractedRootFile = "extracted_40.root"
