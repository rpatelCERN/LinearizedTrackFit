...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 68
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 69
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 70
process.RandomNumberGeneratorService.mix.initialSeed            = 71
...
process.MIBextraction.extractedRootFile = "extracted_68.root"
