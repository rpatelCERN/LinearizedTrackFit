...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 92
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 93
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 94
process.RandomNumberGeneratorService.mix.initialSeed            = 95
...
process.MIBextraction.extractedRootFile = "extracted_92.root"
