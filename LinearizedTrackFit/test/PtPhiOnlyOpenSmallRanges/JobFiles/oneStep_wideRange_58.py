...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 58
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 59
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 60
process.RandomNumberGeneratorService.mix.initialSeed            = 61
...
process.MIBextraction.extractedRootFile = "extracted_58.root"
