...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 56
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 57
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 58
process.RandomNumberGeneratorService.mix.initialSeed            = 59
...
process.MIBextraction.extractedRootFile = "extracted_56.root"
