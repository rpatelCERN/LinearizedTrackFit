...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 32
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 33
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 34
process.RandomNumberGeneratorService.mix.initialSeed            = 35
...
process.MIBextraction.extractedRootFile = "extracted_32.root"
