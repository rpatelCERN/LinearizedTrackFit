...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 41
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 42
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 43
process.RandomNumberGeneratorService.mix.initialSeed            = 44
...
process.MIBextraction.extractedRootFile = "extracted_41.root"
