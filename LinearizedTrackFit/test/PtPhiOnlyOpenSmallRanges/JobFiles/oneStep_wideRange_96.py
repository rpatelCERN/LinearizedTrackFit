...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 96
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 97
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 98
process.RandomNumberGeneratorService.mix.initialSeed            = 99
...
process.MIBextraction.extractedRootFile = "extracted_96.root"
