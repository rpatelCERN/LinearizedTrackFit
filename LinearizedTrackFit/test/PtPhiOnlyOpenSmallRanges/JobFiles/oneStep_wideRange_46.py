...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 46
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 47
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 48
process.RandomNumberGeneratorService.mix.initialSeed            = 49
...
process.MIBextraction.extractedRootFile = "extracted_46.root"
