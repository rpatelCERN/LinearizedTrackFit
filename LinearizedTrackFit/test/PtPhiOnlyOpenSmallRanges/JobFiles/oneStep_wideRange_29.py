...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 29
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 30
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 31
process.RandomNumberGeneratorService.mix.initialSeed            = 32
...
process.MIBextraction.extractedRootFile = "extracted_29.root"
