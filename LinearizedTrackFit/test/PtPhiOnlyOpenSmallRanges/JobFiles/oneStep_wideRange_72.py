...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 72
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 73
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 74
process.RandomNumberGeneratorService.mix.initialSeed            = 75
...
process.MIBextraction.extractedRootFile = "extracted_72.root"
