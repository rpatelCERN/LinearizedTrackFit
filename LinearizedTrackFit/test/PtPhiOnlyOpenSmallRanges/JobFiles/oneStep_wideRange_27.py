...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 27
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 28
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 29
process.RandomNumberGeneratorService.mix.initialSeed            = 30
...
process.MIBextraction.extractedRootFile = "extracted_27.root"
