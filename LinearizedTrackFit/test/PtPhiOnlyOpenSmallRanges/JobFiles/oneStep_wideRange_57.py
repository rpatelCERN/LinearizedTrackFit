...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 57
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 58
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 59
process.RandomNumberGeneratorService.mix.initialSeed            = 60
...
process.MIBextraction.extractedRootFile = "extracted_57.root"
