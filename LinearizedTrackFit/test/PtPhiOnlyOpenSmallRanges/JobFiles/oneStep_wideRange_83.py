...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 83
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 84
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 85
process.RandomNumberGeneratorService.mix.initialSeed            = 86
...
process.MIBextraction.extractedRootFile = "extracted_83.root"
