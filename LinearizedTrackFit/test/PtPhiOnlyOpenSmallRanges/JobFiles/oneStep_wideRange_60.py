...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 60
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 61
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 62
process.RandomNumberGeneratorService.mix.initialSeed            = 63
...
process.MIBextraction.extractedRootFile = "extracted_60.root"
