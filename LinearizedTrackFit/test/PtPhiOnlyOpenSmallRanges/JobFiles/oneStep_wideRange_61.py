...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 61
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 62
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 63
process.RandomNumberGeneratorService.mix.initialSeed            = 64
...
process.MIBextraction.extractedRootFile = "extracted_61.root"
