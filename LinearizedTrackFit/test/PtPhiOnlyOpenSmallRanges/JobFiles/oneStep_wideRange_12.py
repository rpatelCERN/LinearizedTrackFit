...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 12
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 13
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 14
process.RandomNumberGeneratorService.mix.initialSeed            = 15
...
process.MIBextraction.extractedRootFile = "extracted_12.root"
