...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 74
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 75
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 76
process.RandomNumberGeneratorService.mix.initialSeed            = 77
...
process.MIBextraction.extractedRootFile = "extracted_74.root"
