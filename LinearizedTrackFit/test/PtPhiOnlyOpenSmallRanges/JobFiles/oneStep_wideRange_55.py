...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 55
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 56
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 57
process.RandomNumberGeneratorService.mix.initialSeed            = 58
...
process.MIBextraction.extractedRootFile = "extracted_55.root"
