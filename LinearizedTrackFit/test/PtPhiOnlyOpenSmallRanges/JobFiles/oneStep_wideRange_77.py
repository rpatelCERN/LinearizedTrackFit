...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 77
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 78
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 79
process.RandomNumberGeneratorService.mix.initialSeed            = 80
...
process.MIBextraction.extractedRootFile = "extracted_77.root"
