...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 22
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 23
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 24
process.RandomNumberGeneratorService.mix.initialSeed            = 25
...
process.MIBextraction.extractedRootFile = "extracted_22.root"
