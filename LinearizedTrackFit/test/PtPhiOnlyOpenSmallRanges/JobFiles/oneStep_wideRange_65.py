...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 65
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 66
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 67
process.RandomNumberGeneratorService.mix.initialSeed            = 68
...
process.MIBextraction.extractedRootFile = "extracted_65.root"
