...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 37
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 38
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 39
process.RandomNumberGeneratorService.mix.initialSeed            = 40
...
process.MIBextraction.extractedRootFile = "extracted_37.root"
