...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 59
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 60
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 61
process.RandomNumberGeneratorService.mix.initialSeed            = 62
...
process.MIBextraction.extractedRootFile = "extracted_59.root"
