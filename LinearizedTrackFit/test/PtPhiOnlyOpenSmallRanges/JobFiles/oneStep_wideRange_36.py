...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 36
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 37
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 38
process.RandomNumberGeneratorService.mix.initialSeed            = 39
...
process.MIBextraction.extractedRootFile = "extracted_36.root"
