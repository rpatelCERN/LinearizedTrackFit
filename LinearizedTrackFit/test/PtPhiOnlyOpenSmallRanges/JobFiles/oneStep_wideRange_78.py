...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 78
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 79
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 80
process.RandomNumberGeneratorService.mix.initialSeed            = 81
...
process.MIBextraction.extractedRootFile = "extracted_78.root"
