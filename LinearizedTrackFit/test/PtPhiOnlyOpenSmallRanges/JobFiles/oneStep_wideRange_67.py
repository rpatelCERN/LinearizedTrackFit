...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 67
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 68
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 69
process.RandomNumberGeneratorService.mix.initialSeed            = 70
...
process.MIBextraction.extractedRootFile = "extracted_67.root"
