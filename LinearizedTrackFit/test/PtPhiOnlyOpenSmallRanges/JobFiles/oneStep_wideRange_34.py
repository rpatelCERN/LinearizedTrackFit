...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 34
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 35
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 36
process.RandomNumberGeneratorService.mix.initialSeed            = 37
...
process.MIBextraction.extractedRootFile = "extracted_34.root"
