...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 76
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 77
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 78
process.RandomNumberGeneratorService.mix.initialSeed            = 79
...
process.MIBextraction.extractedRootFile = "extracted_76.root"
