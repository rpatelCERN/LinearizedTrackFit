...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 81
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 82
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 83
process.RandomNumberGeneratorService.mix.initialSeed            = 84
...
process.MIBextraction.extractedRootFile = "extracted_81.root"
