...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = GENERATORSEED
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = VTXSMEAREDSEED
...
#	YFlatSpread = cms.double(1.5),  # In mm  of the official 
	...
	# Eta = 0.2
        MinEta = cms.double(0.25),
        MaxEta = cms.double(0.35),
	# Phi = 0
        MinPhi = cms.double(-0.04),
...
process.MIBextraction.extractedRootFile = "extracted_INDEX.root"
