...
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 4
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 5
process.RandomNumberGeneratorService.mix.initialSeed            = 6
...
process.MIBextraction.extractedRootFile = "extracted_3.root"
