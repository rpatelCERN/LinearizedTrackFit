...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 8
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 9
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 10
process.RandomNumberGeneratorService.mix.initialSeed            = 11
...
process.MIBextraction.extractedRootFile = "extracted_8.root"
