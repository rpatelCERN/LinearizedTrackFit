...
# Random seeds
process.RandomNumberGeneratorService.generator.initialSeed      = 9
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 10
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 11
process.RandomNumberGeneratorService.mix.initialSeed            = 12
...
process.generator = cms.EDProducer("FlatRandomOneOverPtGunProducer",
	...
	# pt = 500 GeV
	MinOneOverPt = cms.double(0.002),
        MaxOneOverPt = cms.double(0.002),
...
#	ZFlatSpread = cms.double(150.), # In mm  PGUN code, see tutorial)
	...
	# Eta = 0.2 +/- 0.1
        MinEta = cms.double(0.15),
        MaxEta = cms.double(0.25),
	# Phi = 0 +/- 0.1
...
process.MIBextraction.extractedRootFile = "extracted_9.root"
