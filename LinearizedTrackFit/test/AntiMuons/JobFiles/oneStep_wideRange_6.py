...
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 7
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 8
process.RandomNumberGeneratorService.mix.initialSeed            = 9
...
process.MIBextraction.extractedRootFile = "extracted_6.root"
