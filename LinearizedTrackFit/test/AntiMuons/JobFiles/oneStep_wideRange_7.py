...
process.RandomNumberGeneratorService.VtxSmeared.initialSeed     = 8
process.RandomNumberGeneratorService.g4SimHits.initialSeed      = 9
process.RandomNumberGeneratorService.mix.initialSeed            = 10
...
process.MIBextraction.extractedRootFile = "extracted_7.root"
