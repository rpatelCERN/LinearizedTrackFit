...
def prepare_second_estimates():
    ...
    for regions_number in regions_number_names:
        ...
        for pt_distribution_name in file_full_list:
            ...
            #                  pt_distribution_name, regions_number)
            #
            # job_types = [JobType("Longitudinal_Rz_flatPtTgThetaAndPtPreEstimate", ["CorrectedZSecondOrder"], ["cotTheta", "z0"])]
            # prepare_all_jobs(job_types, "/FlatPt/PreEstimate_Transverse",
            #                  "/FlatPt/PreEstimate_Longitudinal_Rz", file_full,
            #                  pt_distribution_name, regions_number)
